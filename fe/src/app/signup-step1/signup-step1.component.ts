...
export class SignupStep1Component implements OnInit {
  ...
  ngOnInit() {
    this.dataStep1 = this.fb.group({
      ...
      confirmPassword:["",[Validators.minLength(6),Validators.maxLength(12),Validators.required]]
    })
  }

  public submitStep1(){
    if(this.dataStep1.value.password != this.dataStep1.value.confirmPassword){
